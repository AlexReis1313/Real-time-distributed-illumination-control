...
void loop() {
  ...
  if (data_available) {
    ...
    time4=micros();
    Serial.print("Time to send in node ");Serial.print(time2-time1);Serial.print(" Time in travel ");Serial.print(time3-time2);Serial.print(" Time to read ");Serial.println(time4-time3);
  }
}